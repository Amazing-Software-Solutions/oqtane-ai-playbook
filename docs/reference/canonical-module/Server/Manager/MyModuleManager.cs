...
namespace TheCompany.Module.MyModule.Manager
{
    public class MyModuleManager : MigratableModuleBase, IInstallable, IPortable, ISearchable
    {
        ...
        {
            return Migrate(new MyModuleContext(_DBContextDependencies), tenant, MigrationType.Down);
        }
